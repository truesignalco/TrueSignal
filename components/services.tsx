...
},
{
  ...
  deliverables: ["Strategic insight deck", "Consumer grounded framework", "Leadership ready presentation", "Activation recommendations"],
  ...
  return (
    <section style={{
      ...
      <Link href="/contact" style={{textDecoration: 'none'}}>
        <button style={{ background: 'white', color: WIRE_ACCENT, border: 0, cursor: 'pointer',
